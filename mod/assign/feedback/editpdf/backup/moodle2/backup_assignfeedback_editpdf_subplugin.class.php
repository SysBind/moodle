...
class backup_assignfeedback_editpdf_subplugin extends backup_subplugin {
    ...
    protected function define_grade_subplugin_structure() {
        ...
        $subpluginelementannotation = new backup_nested_element('annotation', null,
            array('gradeid', 'pageno', 'type', 'x', 'y', 'endx', 'endy', 'colour', 'path', 'draft'));
        $subpluginelementcomments = new backup_nested_element('feedback_editpdf_comments');
        $subpluginelementcomment =
            new backup_nested_element('comment', null, array('gradeid', 'pageno', 'x', 'y', 'width', 'rawtext', 'colour', 'draft'));
        $subpluginelementhtmlcomments = new backup_nested_element('feedback_editpdf_htmlcomments');
        $subpluginelementhtmlcomment =
            new backup_nested_element('htmlcomment', null, array('gradeid', 'pageno', 'x', 'y', 'width', 'rawtext', 'draft'));
        ...
        $subpluginelementfiles->set_source_sql('SELECT id AS gradeid from {assign_grades} where id = :gradeid',
