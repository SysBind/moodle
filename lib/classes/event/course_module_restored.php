...
/**
 * Event to be triggered when a  course module been restored.
 *
 * @package    core
...
/**
 * Class course_module_restored
 *
 * Class for event to be triggered when a course module been restored.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - string modulename: name of module restored.
 ...
 * @package    core
 * @since      Moodle 3.1
 * @copyright  2013 Meir Ifrach
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later.
 */
class course_module_restored extends base {
    /**
    ...
    public static function get_name() {
        return get_string('eventcoursemodulerestored', 'core');
    }
    /**
    ...
    public function get_description() {
        return "The user with id '$this->userid' restore the '{$this->other['modulename']}' activity with " .
    ...
    protected function get_legacy_logdata() {
        $log1 = array($this->courseid, "course", "restored mod", "../mod/" . $this->other['modulename'] . "/view.php?id=" .
                $this->objectid, $this->other['modulename'] . " " . $this->other['instanceid']);
        $log2 = array($this->courseid, $this->other['modulename'], "restored",
