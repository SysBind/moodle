...
module.exports = function(grunt) {
    ...
    tasks.ignorefiles = function() {
      ...
      var eslintIgnores = ['# Generated by "grunt ignorefiles"','*/**/amd/src/jsxgen' ,'*/**/yui/src/*/meta/', '*/**/build/'].concat(thirdPartyPaths);
	...
	for (idx in files) {
		...
		grunt.log.writeln('JSX to javascript file: ' + f);
		grunt.util.spawn({
    ...
    grunt.registerTask('js', ['jsx', 'amd', 'yui']);
